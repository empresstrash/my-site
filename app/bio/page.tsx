    ...
    <div className="bio-page">
      ...
      <section className="bio-section">
        ...
        <ul className="cv-list">
          <li><strong>2026:</strong> Curator and artist for Visible Violets V2 with One Love Art DAO and built a gallery in SubstrataVR (early March); curated Cusp of Rebirth V1 birthday exhibition and built a gallery in SubstrataVR (March); curated into and exhibited obey//resist in Beeple and Shepard Fairey Obey and Resist at Beeple Studios Charleston South Carolina (March); interviewed on Beyond the NFT with SinfulMeatStick in Decentraland (late March); Body Mapping exhibited in Built to Create Art in the Age of the Robot at mHUB Chicago (April 29); Body Mapping II selected for Sintesis exhibition in CDMX curated by Karen Medina (May); artist curator for RGB MTL 2026 digital art showcase in Montreal (May)</li>
          <li><strong>2025:</strong> Partner Artist Ambassador for Gamma, curating drops + featured on Ordinals Calendar; Neon Noir models launch on Titles.xyz with custom AI training (ethical royalties, permissionless collabs); NEONCHAIN summer kickoff drop with betrmint; Debut speaking in TIMEPieces spaces on artist series; "Angel of Justice" billboard at NFT NYC Midtown and one of the first Midjourney videos exhibited worldwide at Oculus Center; Barco Utopia Museum exhibition in CDMX; Accepted to Sincretismo Digital Art Residency, Mexico City; Work exhibited at BrunchByFidel (presented by ClickCreate), Gates South Beach, Miami; Sincretismo Digital Residency exhibition ("The Comet" immersive audio-reactive installation), CDMX; Short film "Dance of the Skeletons" screened at Las Flores Web3 Film Festival, Canadian Consulate, Mexico City (October); Commissioned drop "Yule Log 2025" with betrmint on bp.fun (December); Group drop "BURN EVERYTHING" organized by mentalnoise_e, piece "Muñeco de Año Viejo: Poverty + Despair" on objkt, 9000 editions (December); Interview on TezosCommons Artz Friday spaces, hosted by YinYangYoeshi (December); Full moon airdrop to holders on Tezos and Base (ongoing); ongoing physical rehab + finished Damsels collection</li>
          <li><strong>2024:</strong> Times Square billboard during Summer Olympics (censorship tribute to George Carlin's 7 words); Belgium billboard takeover (780+ screens via ArtCrush Gallery); Zona Maco digital display with PalmDAO and SuperchiefNFT (Latin America's largest art fair); Bitcoin Ordinals and Gamma Artist Ambassador; Extensive curations; AoTM curation "Whispers and Closed Doors" with piece "I Love You, It's Ruining My Life" auctioned (June); The Poetry of The Blockchain extended from 2023 (Flux Collective, SAP HQ Walldorf, Germany); Tzompantli with Opuntia Art Collective (NFTFactory, Paris); Marigolds group drop on Gamma (November)</li>
          ...
          <li><strong>2019–2020:</strong> NY Day Show solo (Oakland); Art Will Never Break Your Heart solo (Oakland); Create//Destroy co-exhibit (Oakland); Red Light Art Show organized/curated (Oakland).</li>
          <li><strong>2018:</strong> Live Painting (private wedding, Moraga); Emotional Landscapes solo (Philz Noe Valley, San Francisco).</li>
          <li><strong>2017:</strong> Muralist (Philz Gilman and Shattuck, Berkeley); I Can Breathe solo (Snappy's Cafe, Hayward); Exhibition (Alameda Arts, Alameda).</li>
